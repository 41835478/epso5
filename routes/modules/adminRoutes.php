...
Route::group([
        ...
        //Edaphologies 
        Route::resource('edaphologies', 'Dashboard\EdaphologiesController', ['only' => ['store', 'edit', 'update']]);
        Route::get('edaphologies/create/{id}', 'Dashboard\EdaphologiesController@create')->name('edaphologies.create');
