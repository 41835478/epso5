...
class CityTest extends BrowserKitTestCase
{
    ...
    /*
    |--------------------------------------------------------------------------
    | Access to cities's page
    |--------------------------------------------------------------------------
    */
    public function test_god_can_access_to_cities_list()
    {
    ...
    public function test_admin_can_access_to_cities_list()
    {
    ...
    public function test_editor_can_access_to_cities_list()
    {
    ...
    public function test_user_cant_access_to_cities_list()
    {
