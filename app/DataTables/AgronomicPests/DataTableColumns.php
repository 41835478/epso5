...
trait DataTableColumns
{
    ...
    protected function setColumns() : array
    {
        ...
        $columns = [
            $this->setColumnWithRelationship(trans_title('pests', 'singular'), 'pest.pest_name', ['defaultContent' => no_result()]),
    ...
    //         $this->createCheckbox(),
    //         $this->setColumn(trans('financials.id'), 'id'),
    //         $this->setColumn(trans_title('agronomic_pests'), 'agronomicpest_name'),
