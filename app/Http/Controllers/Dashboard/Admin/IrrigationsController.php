...
use App\DataTables\Irrigations\DataTable;
use App\Http\Controllers\DashboardController;
use App\Repositories\Irrigations\IrrigationsRepository;
use App\Http\Requests\IrrigationsRequest;
//use Credentials;
//use Illuminate\Http\Request;

class IrrigationsController extends DashboardController
{
    /**
     * @var protected
     */
    ...
    private $role       = 'admin';
    private $section    = 'irrigations';

    public function __construct(IrrigationsRepository $controller, DataTable $table)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(IrrigationsRequest $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(IrrigationsRequest $request, $id)
    {
